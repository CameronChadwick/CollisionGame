...
class Grass():
    ...
    def grass_collide_top(self):
        if player.y <= self.y + 20:
            player.y = 21

    def grass_collide_bottom(self):
...
grass1 = Grass(0, 0, 800, 50, GRASSGREEN)
grass2 = Grass(0, 350, 800, 50, GRASSGREEN)
...
while running:
    ...
    road2.draw_road()
    grass1.draw_grass()
    grass1.grass_collide_top()
    grass2.draw_grass()
    grass2.grass_collide_bottom()
    player.draw_car()
    player.update()
